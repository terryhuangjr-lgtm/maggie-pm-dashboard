            ...
            {property.lease_end && (
              <div className="detail-field">
                ...
                <div className="detail-field-value" style={{
                  color: new Date(property.lease_end + 'T12:00:00') < new Date() ? 'var(--red)' :
                         new Date(property.lease_end + 'T12:00:00') < new Date(Date.now() + 30*24*60*60*1000) ? 'var(--yellow)' : 'inherit',
                  fontWeight: new Date(property.lease_end + 'T12:00:00') < new Date() ? 600 : 'normal'
                }}>
                  {new Date(property.lease_end + 'T12:00:00').toLocaleDateString()}
                  {new Date(property.lease_end + 'T12:00:00') < new Date() ? ' (EXPIRED)' : ''}
                </div>
              </div>
            )}
            ...
            {lease ? (
              <>
                ...
                <div className="detail-field">
                  ...
                  <div className="detail-field-value" style={{
                    color: new Date(lease.lease_end + 'T12:00:00') < new Date() ? 'var(--red)' :
                    ...
                    {new Date(lease.lease_end + 'T12:00:00') < new Date() ? ' (EXPIRED)' : ''}
                  </div>
                </div>
